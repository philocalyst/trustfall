...
pub(super) fn resolve_comment_edge<'a, V: AsVertex<Vertex> + 'a, E: 'a>(
...
mod comment {
    ...
    pub(super) fn by_user<'a, V: AsVertex<Vertex> + 'a, E: 'a>(
        contexts: ContextIterator<'a, V>,
    ...
    pub(super) fn link<'a, V: AsVertex<Vertex> + 'a, E: 'a>(
        contexts: ContextIterator<'a, V>,
        _resolve_info: &ResolveEdgeInfo,
    ) -> ContextOutcomeIterator<'a, V, NeighborResolution<'a, Vertex, E>> {
        resolve_neighbors_with(
    ...
    pub(super) fn parent<'a, V: AsVertex<Vertex> + 'a, E: 'a>(
        contexts: ContextIterator<'a, V>,
        _resolve_info: &ResolveEdgeInfo,
    ) -> ContextOutcomeIterator<'a, V, NeighborResolution<'a, Vertex, E>> {
        resolve_neighbors_with(
    ...
    pub(super) fn reply<'a, V: AsVertex<Vertex> + 'a, E: 'a>(
        contexts: ContextIterator<'a, V>,
        _resolve_info: &ResolveEdgeInfo,
    ) -> ContextOutcomeIterator<'a, V, NeighborResolution<'a, Vertex, E>> {
        resolve_neighbors_with(
...
pub(super) fn resolve_job_edge<'a, V: AsVertex<Vertex> + 'a, E: 'a>(
    contexts: ContextIterator<'a, V>,
    edge_name: &str,
    parameters: &EdgeParameters,
    resolve_info: &ResolveEdgeInfo,
...
pub(super) fn resolve_story_edge<'a, V: AsVertex<Vertex> + 'a, E: 'a>(
    contexts: ContextIterator<'a, V>,
    edge_name: &str,
    parameters: &EdgeParameters,
    resolve_info: &ResolveEdgeInfo,
...
mod story {
    ...
    pub(super) fn comment<'a, V: AsVertex<Vertex> + 'a, E: 'a>(
        contexts: ContextIterator<'a, V>,
        _resolve_info: &ResolveEdgeInfo,
    ) -> ContextOutcomeIterator<'a, V, NeighborResolution<'a, Vertex, E>> {
        resolve_neighbors_with(
...
pub(super) fn resolve_user_edge<'a, V: AsVertex<Vertex> + 'a, E: 'a>(
    contexts: ContextIterator<'a, V>,
    edge_name: &str,
    parameters: &EdgeParameters,
    resolve_info: &ResolveEdgeInfo,
...
mod user {
    ...
    pub(super) fn submitted<'a, V: AsVertex<Vertex> + 'a, E: 'a>(
        contexts: ContextIterator<'a, V>,
        _resolve_info: &ResolveEdgeInfo,
    ) -> ContextOutcomeIterator<'a, V, NeighborResolution<'a, Vertex, E>> {
        resolve_neighbors_with(
