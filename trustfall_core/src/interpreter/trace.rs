...
pub fn tap_results<'vertex, AdapterT>(
    ...
    result_iter: impl Iterator<Item = Result<BTreeMap<Arc<str>, FieldValue>, ExecutionError<AdapterT::Error>>>
    + 'vertex,
) -> impl Iterator<Item = Result<BTreeMap<Arc<str>, FieldValue>, ExecutionError<AdapterT::Error>>> + 'vertex
where
    ...
    ) -> ContextOutcomeIterator<'vertex, V, VertexIterator<'vertex, Result<Self::Vertex, Self::Error>>>
    {
        ...
        Box::new(
            ...
            .map(move |(context, neighbor_iter)| {
                ...
                let final_neighbor_iter: VertexIterator<'vertex, Result<Self::Vertex, Self::Error>> =
